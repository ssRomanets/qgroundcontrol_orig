...
Item {
    ...
    property real   m_margins:           ScreenTools.defaultFontPixelHeight * 0.5
    ...
    Loader {
        id:                     headerLoader
        anchors.topMargin:      m_margins
        anchors.top:            parent.top
        anchors.left:           parent.left
        anchors.rightMargin:    m_margins
    ...
    Item {
        ...
        anchors.top:            headerLoader.sourceComponent === null ?
                                (headingColumn.visible ? headingColumn.bottom : parent.top) : headerLoader.bottom

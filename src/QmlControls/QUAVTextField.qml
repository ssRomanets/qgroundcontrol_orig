...
TextField {
    id:                 control
    color:              quavPal.textFieldText
    selectionColor:     quavPal.textFieldText
    selectedTextColor:  quavPal.textField
    ...
    leftPadding:        m_marginPadding
    rightPadding:       m_marginPadding + unitsHelpLayout.width
    topPadding:         m_marginPadding
    bottomPadding:      m_marginPadding
    ...
    property real m_helpLayoutWidth: 0
    property real m_marginPadding:   ScreenTools.defaultFontPixelHeight / 3
    ...
    background: Rectangle {
        border.width:   control.validationError ? 2 : (quavPal.globalTheme === QUAVPalette.Light ? 1 : 0)
        border.color:   control.validationError ? quavPal.colorRed : quavPal.buttonBorder
        radius:         ScreenTools.buttonBorderRadius
        color:          quavPal.textField
        ...
        RowLayout {
            ...
            anchors.rightMargin:    control.activeFocus ? 2 : control.m_marginPadding
            spacing:                ScreenTools.defaultFontPixelWidth / 4
            layoutDirection:        Qt.RightToLeft

            Component.onCompleted:  control.m_helpLayoutWidth = unitsHelpLayout.width
            onWidthChanged:         control.m_helpLayoutWidth = unitsHelpLayout.width
    ...
    MouseArea {
        ...
        anchors.bottom: parent.bottom
        anchors.right:  parent.right
        width:          control.m_helpLayoutWidth

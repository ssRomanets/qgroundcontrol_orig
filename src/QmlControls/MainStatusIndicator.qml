...
RowLayout {
    ...
    property bool m_healthAndArmingChecksSupported: m_activeVehicle ?
        (m_activeVehicle.healthAndArmingChecksSupported ? m_activeVehicle.healthAndArmingChecksSupported.supported : false ): false

...
public:
    ...
    bool        contains            (const QObject* object) { return m_objectList.indexOf(object) != -1; }
    int         indexOf             (const QObject* object) { return m_objectList.indexOf(object); }
    ...
    template<class T> T value       (int index) const { return qobject_cast<T>(m_objectList[index]); }
    QList<QObject*>* objectList     () { return &m_objectList; }
...
private:
    ...
    bool m_dirty;
    bool m_skipDirtyFirstItem;
    uint m_resetModelNestingCount = 0;

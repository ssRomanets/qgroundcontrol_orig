...
Rectangle {
    ...
    property var m_videoUVCCamera:          camera
    ...
    Timer {
        ...
        repeat:   true;
        onTriggered: {
            if (toggleVideoRecordingAct !== globals.toggleVideoRecordingAct || !m_videoUVCCamera.active)
            {
                if (!m_videoUVCCamera.active && toggleVideoRecordingAct == true && toggleVideoRecordingAct === globals.toggleVideoRecordingAct)
                {
                ...
                else if (m_videoUVCCamera.active && toggleVideoRecordingAct !== globals.toggleVideoRecordingAct)
                {
            ...
            {
                if (m_videoUVCCamera.active) m_camera.takePhoto(m_captureSession)

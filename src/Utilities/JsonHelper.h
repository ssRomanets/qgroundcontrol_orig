...
namespace JsonHelper
{
    ...
    void saveQUAVJsonFileHeader(QJsonObject &jsonObject,  ///< root json object
    ...
    bool validateExternalQUAVJsonFile(const QJsonObject &jsonObject,      ///< json object to validate
    ...
    ///     jsonGroundStationKey - Required and checked to be string type
    /// @return false: validation failed, errorString set
    bool validateInternalQUAVJsonFile(const QJsonObject &jsonObject,      ///< json object to validate
                                     const QString &expectedFileType,    ///< correct file type for file
                                     int minSupportedVersion,            ///< minimum supported version
                                     int maxSupportedVersion,            ///< maximum supported major version
                                     int &version,                       ///< returned file version
    ...
    QJsonObject openInternalQUAVJsonFile(const QString &jsonFilename,     ///< Json file to open
                                        const QString &expectedFileType, ///< correct file type for file
                                        int minSupportedVersion,         ///< minimum supported version
                                        int maxSupportedVersion,         ///< maximum supported major version
                                        int &version,                    ///< returned file version

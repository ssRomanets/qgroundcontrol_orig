...
private:
    ...
    const QString m_mapUrl = QStringLiteral("https://cyberjapandata.gsi.go.jp/xyz/%1/%2/%3/%4.%5");
};
...
private:
    ...
    const QString m_mapUrl = QStringLiteral("http://tile.openstreetmap.org/%1/%2/%3.png");
};
...
private:
    ...
    const QString m_mapTypeId;
    const QString m_mapUrl = QStringLiteral("https://cache.kartverket.no/v1/wmts/1.0.0/topo/default/webmercator/%1/%2/%3");
};
...
private:
    ...
    const QString m_mapUrl = QStringLiteral("https://geodata.npolar.no/arcgis/rest/services/Basisdata/NP_Basiskart_Svalbard_WMTS_3857/MapServer/WMTS/tile/1.0.0/Basisdata_NP_Basiskart_Svalbard_WMTS_3857/default/default028mm/%1/%2/%3");
};
...
private:
    ...
    const QString m_mapUrl = QStringLiteral("http://map.eniro.com/geowebcache/service/tms1.0.0/map/%1/%2/%3.%4");
};
...
private:
    ...
    const QString m_mapTypeId;
    const QString m_mapUrl = QStringLiteral("http://otile%1.mqcdn.com/tiles/1.0.0/%2/%3/%4/%5.%6");
};
...
private:
    ...
    const QString m_mapTypeId;
    const QString m_mapUrl = QStringLiteral("http://api.vworld.kr/req/wmts/1.0.0/%1/%2/%3/%4/%5.%6");
};

...
QGeoTiledMappingManagerEngineQUAV::QGeoTiledMappingManagerEngineQUAV(const QVariantMap &parameters, QGeoServiceProvider::Error *error, QString *errorString, QNetworkAccessManager *networkManager, QObject *parent)
    : QGeoTiledMappingManagerEngine(parent)
    , m_networkManager(networkManager)
{
    // qDebug() << Q_FUNC_INFO << this;

    // TODO: Better way to get current language without quavApp()?
    setLocale(quavApp()->getCurrentLanguage());
    ...
    QGeoFileTileCacheQUAV* const fileTileCache = new QGeoFileTileCacheQUAV(parameters);
    ...
    std::call_once(mapEngineInit, [fileTileCache]() {
        getQUAVMapEngine()->init(fileTileCache->getDatabaseFilePath());
    });
    ...
    QGeoTileFetcherQUAV* const tileFetcher = new QGeoTileFetcherQUAV(m_networkManager, parameters, this);
...
QGeoTiledMappingManagerEngineQUAV::~QGeoTiledMappingManagerEngineQUAV()
{
    // qDebug() << Q_FUNC_INFO << this;
}

QGeoMap *QGeoTiledMappingManagerEngineQUAV::createMap()
{
    QGeoTiledMapQUAV* const map = new QGeoTiledMapQUAV(this, this);

...
private:
    static constexpr const char* m_jsonStatusKey = "status";
    static constexpr const char* m_jsonDataKey = "data";
    static constexpr const char* m_jsonBoundsKey = "bounds";
    static constexpr const char* m_jsonSouthWestKey = "sw";
    static constexpr const char* m_jsonNorthEastKey = "ne";
    static constexpr const char* m_jsonStatsKey = "stats";
    static constexpr const char* m_jsonMaxElevationKey = "max";
    static constexpr const char* m_jsonMinElevationKey = "min";
    static constexpr const char* m_jsonAvgElevationKey = "avg";
    static constexpr const char* m_jsonCarpetKey = "carpet";
};
